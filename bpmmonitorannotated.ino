...
// Otherwise, set myTimer1 equal to 0...
...
// Otherwise, set myTimer2 equal to 0...

// In other words, both timers simply use the desired delays to control how fast the readings are obtained or values printed, and are not affected by anything else...
