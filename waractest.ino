...
BLEUnsignedCharCharacteristic charac ("Numbers", BLERead | BLEWrite | BLENotify);
BLEStringCharacteristic warac ("Words", BLERead | BLEWrite | BLENotify, 40);
...
delay(5000);
  ...
  echoService.addCharacteristic(warac);
